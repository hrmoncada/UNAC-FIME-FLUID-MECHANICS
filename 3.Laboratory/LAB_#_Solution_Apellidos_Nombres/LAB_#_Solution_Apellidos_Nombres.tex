...
\newcommand{\myFacultad}{FACULTAD DE INGENIERIA MECANICA Y ENERGIA}
\newcommand{\myEscuelaProfesional}{ESCUELA PROFESIONAL DE INGENIERIA MECANICA}
\newcommand{\myCurso}{LABORATORIO DE F\'ISICA 1}
\newcommand{\myTarea }{LABORATORIO $N^o$ }
\newcommand{\myNombre}{Tu nombre}
\newcommand{\myEmail}{email\_name@unac.gob,pe}
\newcommand{\myNumTarea}{300} % NUMERO DE LABORATORIO
...
\includegraphics[width=.9\textwidth]{Escudo_UNAC.png}\\[.5cm]
\end{minipage}
